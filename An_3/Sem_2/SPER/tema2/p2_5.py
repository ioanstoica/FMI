...
obstacles = np.array([[-1, -1], [0, 2], [1, 1], [-1, 1]])
...
# Calculul magnitudinii câmpului potențial
magnitude = np.sqrt(u**2 + v**2)

# Trasarea săgeților care indică direcția și magnitudinea câmpului potențial
plt.figure(figsize=(8, 6))
plt.quiver(X, Y, -u, -v, magnitude, cmap='coolwarm', scale=50)
...
plt.colorbar(label='Magnitudinea câmpului potențial')
plt.show()
