drop table member_ist cascade constraints;
drop table title_ist cascade constraints;
drop table title_copy_ist cascade constraints;
drop table rental_ist cascade constraints;
drop table reservation_ist cascade constraints;
drop view title_avail_ist;
...
---------------------------------------------------------------------
INSERT INTO title_ist 
(title_ist_id, title, description, rating, category, release_date)
...
select * from title_ist;
COMMIT;
---------------------------------------------------------------------
INSERT INTO title_copy_ist VALUES (1,92,'RENTED');
INSERT INTO title_copy_ist VALUES (2,92,'AVAILABLE');
INSERT INTO title_copy_ist VALUES (1,93,'AVAILABLE');
INSERT INTO title_copy_ist VALUES (2,93,'AVAILABLE'); 
INSERT INTO title_copy_ist VALUES (1,94,'AVAILABLE'); 
INSERT INTO title_copy_ist VALUES (1,95,'AVAILABLE'); 
INSERT INTO title_copy_ist VALUES (2,95,'RENTED'); 
INSERT INTO title_copy_ist VALUES (3,95,'RENTED');
INSERT INTO title_copy_ist VALUES (1,96,'AVAILABLE');
INSERT INTO title_copy_ist VALUES (1,97,'AVAILABLE');
INSERT INTO title_copy_ist VALUES (1,98,'RENTED');
INSERT INTO title_copy_ist VALUES (2,98,'RENTED');
---------------------------------------------------------------------
COMMIT;

INSERT INTO reservation_ist VALUES (sysdate-1,101,93);
INSERT INTO reservation_ist VALUES (sysdate-2,106,98);

COMMIT;
---------------------------------------------------------------------
INSERT INTO rental_ist VALUES (sysdate-1,2,101,93,null,sysdate+1);
INSERT INTO rental_ist VALUES (sysdate-2,3,102,95,null,sysdate);
INSERT INTO rental_ist VALUES (sysdate-3,1,101,98,null,sysdate-1);
INSERT INTO rental_ist VALUES (sysdate-4,1,106,97,sysdate-2,sysdate-2);
INSERT INTO rental_ist VALUES (sysdate-3,1,101,92,sysdate-2,sysdate-1);

INSERT INTO rental_ist VALUES (sysdate-2,2,102,93,sysdate-1,sysdate-1);
INSERT INTO rental_ist VALUES (sysdate-4,2,106,93,sysdate-2,sysdate-2);
INSERT INTO rental_ist VALUES (sysdate-3,3,101,95,sysdate-2,sysdate);
INSERT INTO rental_ist VALUES (sysdate-5,1,104,98,sysdate-3,sysdate-3);

INSERT INTO rental_ist VALUES (sysdate-6,2,102,92,sysdate-4,sysdate-4);

INSERT INTO rental_ist VALUES (sysdate-2,1,101,93,null,sysdate-1);
INSERT INTO rental_ist VALUES (sysdate-4,1,104,93,sysdate-2,sysdate-2);
INSERT INTO rental_ist VALUES (sysdate-3,2,103,95,null,sysdate);
INSERT INTO rental_ist VALUES (sysdate-5,2,102,98,null,sysdate-1);
