...
class NodParcurgere:
    def __init__(self, info,  g=0, h=0,  parinte=None):
        ...
        self.h = h  # estimare a costului drumului minin pana la scop
        self.f = self.g + self.h  # valoarea functiei f = g + h
...
def breadth_frst(gr, nrSolutiiCautate=1):
    # in coada vom avea doar noduri de tip NodParcurgere (nodurile din arborele de parcurgere)
    c = [NodParcurgere(gr.start)]
